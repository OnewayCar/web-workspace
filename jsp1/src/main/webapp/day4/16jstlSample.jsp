...
<c:forEach var="i" begin="1" end="10" varStatus="status" step="2">
   <!-- for 시작값은 1, 마지막값은 10, 변수명은 var 로 지정 step은 증가값. 기본값 1 -->
   <c:out value="${i*10 }"/><br>
...
<fmt:formatNumber  value="9999999"/> <br>  <!-- formatNumber는 바로 출력과 저장 , value에는 값을 직접 또는 el -->
   ...
   <!-- 시간(hours)을 대문자 표기 => 24시 기준 -->
   <fmt:formatDate value="${datetime1 }" pattern="yyyy-MM-dd HH:mm:ss"/><br> <!-- 2022-11-03 20:14:00 -->
   <!-- 시간(hours)을 소문자 표기 => 12시 기준 -->
   <fmt:formatDate value="${datetime1 }" pattern="yyyy-MM-dd hh:mm:ss"/><br> <!-- 2022-11-03 08:14:00 -->
